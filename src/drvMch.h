...
typedef struct MchSysRec_ {
	...
	int           fruLkup[MAX_FRU_MGMT]; /* Provides index into data arrays for FRUs (and Management Controllers that provide FRU data)
                                             * Index refers to 'ID' of FRU/MGMT, which may be chosen arbitrary for each platform
